<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Discover.aspx.cs" Inherits="Where2Next.Discover" %>
...
<script language="c#" runat="server">
    ...
    <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM [centrelink]">
        </asp:SqlDataSource>
